    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        approve.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Call<com.app.goodbusinessappsurvey.contractorPOJO.contractorBean> call = cr.submit_brand(SharePreferenceUtils.getInstance().getString("survey_id"));
                ...
                alert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        if (value.length() > 0 || value.startsWith("  ")) {
                            ...
                            Call<com.app.goodbusinessappsurvey.contractorPOJO.contractorBean> call = cr.reject_brand(SharePreferenceUtils.getInstance().getString("survey_id"),value);
