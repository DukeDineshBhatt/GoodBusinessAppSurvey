...
import com.app.goodbusinessappsurvey.contractorPOJO.Data;
...
public class ContractorSampleProfile extends Fragment {
    ...
    public void onResume() {
        ...
        Call<com.app.goodbusinessappsurvey.samplePOJO.sampleBean> call = cr.getSamples(SharePreferenceUtils.getInstance().getString("user_id"));
